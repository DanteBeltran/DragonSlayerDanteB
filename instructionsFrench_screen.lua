...
-- Naming Scene
sceneName = "instructionsFrench_screen"
...
function scene:create( event )
    ...
    bkg_image = display.newImageRect("Images/Instructions Screen French.png", display.contentWidth, display.contentHeight)
